...
public class CASHIER extends javax.swing.JFrame {
    ...
    private void tblSaleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSaleMouseClicked
        ...
        if(tblSale.getSelectedRow() != 1){
            Object value = tblSale.getValueAt(tblSale.getSelectedRow(),0);
            jTextField1.setText(value.toString());
            Object value2 = tblSale.getValueAt(tblSale.getSelectedRow(),1);
            jTextField2.setText(value2.toString());
            Object value3 = tblSale.getValueAt(tblSale.getSelectedRow(),2);
